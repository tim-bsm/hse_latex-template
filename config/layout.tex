...
\newcommand{\defaultpagelayout}{
    ...
    \fancyhead[L]{
        \ifshowcompanylogo
            % Company logo and HSE-Logo --> Company logo left
            \ifshowhselogo
            ...
            \fi
        % Only HSE-Logo or no logo --> \headerleft left
        \else
            \vspace{0.5cm}\small \headerleft \vspace{0.08cm}
        \fi
    }
    \fancyhead[R]{
        \ifshowcompanylogo
            % Company logo and HSE-Logo --> HSE-Logo right
            \ifshowhselogo
                \iflang{de}{\hseDe}
                \iflang{en}{\hseEn}
