...
\Acl{dta} wird großgeschrieben und \ac{dta} klein, wie es definiert wurde. Zudem wurde ein \plus\ definiert, welches im Text nicht unterhalb der eigentlichen Schrift positioniert ist (siehe: Test+\plus Test).
